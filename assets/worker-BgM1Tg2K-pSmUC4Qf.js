...
function f(A) {
  ...
  const { start: o, end: a, capacity: w } = t(B.memory, i), s = new Uint8Array(B.memory.buffer.slice(o, a)), n = new TextDecoder().decode(s);
  return B.free(o, w), n;
}
self.onmessage = function(A) {
  ...
  switch (C) {
    ...
    case "compress": {
      self.postMessage({ id: I, data: y(g) });
      break;
    }
  }
};
